...
void setup() {
    ...
    adc->setConversionSpeed(ADC_LOW_SPEED); // change the conversion speed, it recalibrates
    // it can be ADC_VERY_LOW_SPEED, ADC_LOW_SPEED, ADC_MED_SPEED, ADC_HIGH_SPEED or ADC_VERY_HIGH_SPEED
    adc->setSamplingSpeed(ADC_LOW_SPEED); // change the sampling speed, it recalibrates
