...
void setup() {
    ...
    adc->setConversionSpeed(ADC_HIGH_SPEED, ADC_1); // change the conversion speed, it recalibrates
    adc->setSamplingSpeed(ADC_HIGH_SPEED, ADC_1); // change the sampling speed, it recalibrates
