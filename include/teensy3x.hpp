...
template <> struct pin_info_t<board_t::TEENSY_3_2, 0> {
  ...
  static constexpr pin_t pins[] = {pin_t::A0, pin_t::A1, pin_t::A2,  pin_t::A3,
                                   pin_t::A4, pin_t::A5, pin_t::A6,  pin_t::A7,
                                   pin_t::A8, pin_t::A9, pin_t::A10, pin_t::A11,
                                   pin_t::A12};

  static constexpr uint8_t pin2int[] = {10, 255, 255, 255, 9,   0,  6,
                                        7,  2,   3,   255, 255, 5,  4,
                                        1,  8,   255, 255, 255, 11, 255};
};
// make linker happy
